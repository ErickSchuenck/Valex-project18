...
export function activateCard(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = req.body, id = _a.id, securityCode = _a.securityCode, password = _a.password;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    _b.sent();
                    return [4 /*yield*/, checkIfCardIsBlocked(card)];
                case 4:
                    ...
                    return [4 /*yield*/, cardsServices.blockOrUnblockCard(id, 'block')];
                case 5:
                    _b.sent();
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, cardsServices.blockOrUnblockCard(id, 'unblock')];
                case 5:
                    _b.sent();
