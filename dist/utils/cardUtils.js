...
export function checkForCardExpirationDate(expirationDate) {
    return __awaiter(this, void 0, void 0, function () {
        var cardAlreadyExpired;
        return __generator(this, function (_a) {
            cardAlreadyExpired = dayjs(expirationDate).isBefore(dayjs(Date.now()).format("MM-YY"));
...
export function checkIfCardIsBlocked(card) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, card.isBlocked];
        });
    });
}
